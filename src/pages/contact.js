...
export default function Contact() {
  return (
    <Layout>
        ...
        <p>We'd love to hear from you! Whether you have questions, feedback, or any inquiries, feel free to reach out to us through the following channels:</p>
      ...
      <hr />
        ...
        <hr />
          ...
          <p>Follow or contact us on our social platforms:</p>
              ...
              <a href="https://www.linkedin.com/company/nightowllabs" target="_blank" rel="noreferrer">
                <i className="fab fa-linkedin"></i> Night Owl Labs on LinkedIn
              </a>
              <br />              <br />

              <a href="https://twitter.com/night_owl_labs" target="_blank" rel="noreferrer">
